This repository should be documented according to the AREI master documentation architecture.

Do not treat the project as a generic SaaS.
Prioritize data engine, trust, product truth, launch quality, and tool agnostic continuity.
...
- `docs/04-platform/ai-development-guardrails.md`
- `docs/05-quality-control/launch-risks.md`
- `docs/05-quality-control/pre-launch-security-checklist.md`
- `docs/09-decisions/decision-log.md`

Operational naming and rename controls:
- `docs/04-platform/rename-alignment-checklist.md`
- `docs/04-platform/rename-impact-inventory.md`

Governance defines hard project rules.
